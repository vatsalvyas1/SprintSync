...
import { addCommentCountToFeedback, getAllComments, getAllFeedback, registerFeedback, registerFeedbackComment } from "../controllers/retrospective.controller.js";
...
router.route("/add-feedback-commentCount").post(verifyJWT, addCommentCountToFeedback)