...
function CTA() {
  ...
  return (
    <div ref={ctaRef}>
      <section id="cta" className="py-16 bg-gradient-to-br from-purple-50 to-indigo-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-purple-100 p-8 sm:p-12">
            ...
            <p className="font-sans text-lg sm:text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              No distractions. Just your work — organized and visible.
            </p>
            
            {/* CTA Button */}
            <div className="mb-6">
              <button id="cta-button" onClick={handleStartNowClick} className="font-sans inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-indigo-600 hover:bg-purple-600 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-purple-300">
                Start Now
            ...
            <p className="font-sans text-sm text-gray-500 max-w-lg mx-auto">
              Use SprintSync to make retros, QA, and deployment smoother for your team.
            </p>
            
            {/* Quick Benefits */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8 pt-8 border-t border-gray-100">
              <div className="text-center">
                <div className="font-sans text-2xl font-bold text-indigo-600 mb-1">6</div>
                <div className="font-sans text-sm text-gray-600">Integrated Modules</div>
              </div>
              <div className="text-center">
                <div className="font-sans text-2xl font-bold text-indigo-600 mb-1">Real-time</div>
                <div className="font-sans text-sm text-gray-600">Sprint Tracking</div>
              </div>
              <div className="text-center">
                <div className="font-sans text-2xl font-bold text-indigo-600 mb-1">Zero</div>
                <div className="font-sans text-sm text-gray-600">Setup Required</div>
              </div>
            </div>
          </div>
        </div>
