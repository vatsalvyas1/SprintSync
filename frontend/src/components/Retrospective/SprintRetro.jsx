...
function SprintRetro() {
  ...
  return (
    <section className="min-h-screen bg-gray-50 p-6 md:ml-64">
      {/* Header */}
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Sprint Retro Board</h1>
          <p className="text-gray-600">Collect and track retrospective feedback</p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-lg font-semibold text-gray-900">What Went Well</h2>
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-lg font-semibold text-gray-900">What Didn't Go Well</h2>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg border border-gray-200 p-6 text-center">
          <div className="text-2xl font-bold text-green-600 mb-2">{getTotalFeedback()}</div>
          <div className="text-sm text-gray-600">Total Feedback</div>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-6 text-center">
          <div className="text-2xl font-bold text-blue-600 mb-2">{getTotalVotes()}</div>
          <div className="text-sm text-gray-600">Total Votes</div>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-6 text-center">
          <div className="text-2xl font-bold text-purple-600 mb-2">{getTotalComments()}</div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-6">Feedback Themes</h3>
        <div className="flex flex-wrap items-center justify-center gap-4 py-8">
          <span className="text-3xl font-bold text-blue-600">Communication</span>
          <span className="text-2xl font-semibold text-green-600">Collaboration</span>
          <span className="text-xl font-medium text-purple-600">Testing</span>
          <span className="text-2xl font-semibold text-red-600">Migration</span>
          <span className="text-lg font-medium text-orange-600">Planning</span>
          <span className="text-xl font-medium text-indigo-600">Requirements</span>
          <span className="text-lg font-medium text-pink-600">Standup</span>
          <span className="text-2xl font-semibold text-teal-600">Knowledge</span>
          <span className="text-lg font-medium text-yellow-600">Process</span>
          <span className="text-xl font-medium text-gray-600">Integration</span>
        </div>
      </div>
      ...
      {feedbackModal && (
        <div className="fixed inset-0 z-50 overflow-y-auto" aria-modal="true">
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            <div className="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75" onClick={closeFeedbackModal}></div>
      ...
      {/* Comments Modal */}
      {commentModal && (
        <div className="fixed inset-0 z-50 overflow-y-auto backdrop-blur-xs" aria-modal="true">
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20">
            <div className="fixed  bg-gray-500 bg-opacity-75" onClick={closeCommentModal}></div>
            ...
            <div className="relative bg-white rounded-lg shadow-xl w-full max-w-2xl p-6 z-10">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
                <p className="text-sm text-gray-900 mb-2">Great collaboration between frontend and backend teams during API integration</p>
                <div className="flex items-center space-x-2">
              ...
              <div className="space-y-4 mb-6 max-h-96 overflow-y-auto">
                {comments.map(comment => (
                  <div key={comment.id} className="flex items-start space-x-3">
                    <img className="w-8 h-8 rounded-full" src={comment.avatar} alt="User" />
              ...
              <div className="border-t border-gray-200 pt-4">
                <div className="flex items-start space-x-3">
                  <img className="w-8 h-8 rounded-full" src="https://avatar.iran.liara.run/public/45" alt="Current user" />
                  <div className="flex-1">
                    <textarea 
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                      rows="2" 
                    ...
                    <div className="flex items-center justify-end mt-2">
                      <button 
                        ...
                        className="px-3 py-1 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Comment
                      </button>
                    </div>
